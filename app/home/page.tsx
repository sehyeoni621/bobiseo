  ...
  return (
    <MobileFrame showNav>
      <div className="animate-fade-in">
        ...
        >
          <div>
            <p className="text-[24px] font-bold leading-tight" style={{ color: "var(--text-primary)" }}>
              안녕하세요,
              <br />
              {userName}님
            </p>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-150 active:scale-90 relative"
        ...
        <div className="px-5 py-6" style={{ background: "var(--bg-primary)" }}>
          ...
          >
            ...
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--accent-green)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
